...
@interface VFAspectRatioTests_aspectSizeThatFitsInside : VFAspectRatioTests

@end

@implementation VFAspectRatioTests_aspectSizeThatFitsInside
...
- (void)testAspectSizeThatFitsInside {
    CGSize actualSize = [self.aspectRatio aspectSizeThatFitsInside:self.inputSize];
